...
async function doBuild(){
    ...
    if(!fs.existsSync(`td-${vers.tdlib}-${sysbit}-build`)){
        fs.mkdirSync(`td-${vers.tdlib}-${sysbit}-build`);
    }
    else{
        fse.removeSync(`td-${vers.tdlib}-${sysbit}-build`);
        fs.mkdirSync(`td-${vers.tdlib}-${sysbit}-build`);
    }
    process.chdir(`td-${vers.tdlib}-${sysbit}-build`);
